...
my_path = 'C:/Users/Saulo/source/repos/IC/Neural Network' # set ur path in order to save the figures or do as stated above and use show()
...
#use new methods, maybe use more than two chars
